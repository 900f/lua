  ...
  return (
    <>
      ...
      <aside className={`sidebar${open?' open':''}`}>
        <div className="sidebar-logo"><span className="logo-accent">Luvenn</span></div>
...
function IconChart(){return <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/><path d="M5 3v4M3 5h4M6 17v4M4 19h4"/></svg>;}
