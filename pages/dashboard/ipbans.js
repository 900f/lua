  ...
  return (
    <Layout user={user}>
      ...
      <div className="card">
        ...
        :bans.length===0?<div className="empty-state"><div className="empty-icon"><ShieldIcon/></div><div className="empty-title">No banned IPs</div><div className="empty-sub">Ban IPs here or from the Executions log</div></div>
        :(
  ...
  return(
    <div className="modal-overlay" onClick={e=>e.target===e.currentTarget&&onClose()}>
      <div className="modal" style={{maxWidth:420}}>
        ...
        <div className="modal-sub">Blocked immediately from all your scripts.</div>
